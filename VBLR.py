...
#     '''
#
#     def __init__(self, n_iter=50, tol=1e-3, solver='lbfgs_b', n_iter_solver=15, tol_solver=1e-3, fit_intercept=True,
#                  alpha=1e-6, verbose=False):
...
class VBLogisticRegression(BayesianLogisticRegression):
   ...
   [2] Murphy 2012, Machine Learning A Probabilistic Perspective ( Chapter 21 )
    ...
    def __init__(self, n_iter=50, tol=1e-3, fit_intercept=True, a=1e-4, b=1e-4, verbose=True):
